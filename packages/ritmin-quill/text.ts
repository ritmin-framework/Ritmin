...
export default class Text {
    ...
    public validateText(text: string, minLength: number = 0, maxLength: number = Infinity): boolean {
    ...
    public replaceText(text: string, search: string, replacement: string): string {
